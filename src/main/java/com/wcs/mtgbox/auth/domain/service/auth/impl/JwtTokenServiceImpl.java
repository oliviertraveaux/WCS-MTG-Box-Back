...
public class JwtTokenServiceImpl implements JwtTokenService {
    ...
    public int JWT_TOKEN_VALIDITY_IN_MINUTE;
    ...
    public Token generateToken(UserDetails userDetails) {
        ...
        token.setToken(Jwts.
                ...
                .setExpiration(new Date(now.getTime() + (long) JWT_TOKEN_VALIDITY_IN_MINUTE * 60 * 1000))
    ...
    public ResponseCookie createJwtCookie(String tokenValue) {
        return ResponseCookie.from("token", tokenValue)
                ...
                .maxAge(JWT_TOKEN_VALIDITY_IN_MINUTE * 60L)
                .sameSite("Strict")
                .build();
    }
